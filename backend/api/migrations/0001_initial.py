# Generated by Django 5.0.6 on 2024-07-22 02:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_number', models.CharField(max_length=20, validators=[django.core.validators.MinLengthValidator(6), django.core.validators.MaxLengthValidator(11)], verbose_name='registration number')),
                ('role', models.CharField(choices=[('student', 'Student'), ('clerk', 'Clerk'), ('faculty', 'Faculty'), ('super-admin', 'Super-Admin'), ('principal', 'Principal'), ('caretaker', 'Caretaker'), ('department', 'Department')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college_id', models.UUIDField(default=uuid.uuid4, editable=False, verbose_name='college_id')),
        ...
        migrations.AddConstraint(
            model_name='user',
            constraint=models.UniqueConstraint(fields=('registration_number', 'college'), name='unique_registration_number_per_college'),
        ),
        migrations.AddConstraint(
            model_name='no_dues_list',
