# Generated by Django 5.0.6 on 2024-08-17 20:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_number', models.CharField(max_length=11, unique=True, validators=[django.core.validators.MinLengthValidator(6), django.core.validators.MaxLengthValidator(11)], verbose_name='registration number')),
                ('role', models.CharField(choices=[('student', 'Student'), ('office', 'Office'), ('faculty', 'Faculty'), ('super-admin', 'Super-Admin'), ('hod', 'HOD'), ('principal', 'Principal'), ('caretaker', 'Caretaker'), ('department', 'Department'), ('registrar', 'Registrar')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefered_room_type', models.CharField(blank=True, choices=[('single', 'Single'), ('double', 'Double'), ('triple', 'Triple')], max_length=125, null=True, verbose_name='Prefered Room')),
                ('latest_marksheet', models.BinaryField(blank=True, null=True, verbose_name='marksheet')),
                ('status', models.CharField(blank=True, choices=[('not-applied', 'Not-applied'), ('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='not-applied', max_length=225, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_no', models.IntegerField(blank=True, null=True, verbose_name='room no')),
                ('current_occupancy', models.IntegerField(blank=True, default=0, null=True, verbose_name='current occupancy')),
                ('capacity', models.IntegerField(blank=True, null=True, verbose_name='capacity')),
                ('room_type', models.CharField(blank=True, choices=[('single', 'Single'), ('double', 'Double'), ('triple', 'Triple')], max_length=20, null=True, verbose_name='room type')),
                ('status', models.CharField(blank=True, choices=[('not-available', 'Not available'), ('available', 'Available'), ('occupied', 'Occupied')], default='not-available', max_length=20, null=True, verbose_name='room status')),
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.college', verbose_name='hostel_rooms')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('allotment_details', models.ManyToManyField(related_name='hostel_room_allotment', to='api.hostel_allotment')),
                ('hostel_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.hostelrooms')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.college', verbose_name='subjects')),
            ],
        ),
        migrations.CreateModel(
            name='Semester',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('branch', models.CharField(blank=True, max_length=225, null=True, verbose_name='branch')),
                ('branch_name', models.CharField(blank=True, max_length=225, null=True, verbose_name='branch_name')),
                ('semester_name', models.CharField(max_length=225, verbose_name='semester_name')),
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.college', verbose_name='semester')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_registrations_college', to='api.college')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not-applied', 'Not-applied'), ('pending', 'Pending'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='not-applied', max_length=225, verbose_name='status')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bonafide_student', to='api.userprofile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='semester_verification', to='api.college')),
