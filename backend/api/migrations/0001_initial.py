    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Student'), ('office', 'Office'), ('faculty', 'Faculty'), ('admin', 'Admin'), ('principal', 'Principal'), ('caretaker', 'Caretaker'), ('department', 'Department')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved')], max_length=225, verbose_name='status')),
                ('approved_date', models.DateField(blank=True, null=True, verbose_name='approved_date')),
                ('applied_date', models.DateField(auto_now=True, verbose_name='applied_date')),
